...
var boreal_wildlands = ee
  .FeatureCollection("projects/canvas-setup-437317-u8/assets/boreal_wildlands")
  .map(function (f) {
...
var bestSept23 = getBestComposite(2023, 9, 9, boreal_wildlands);
var bestSept24 = getBestComposite(2024, 9, 9, boreal_wildlands);
var bestSept25 = getBestComposite(2025, 9, 9, boreal_wildlands);

// 6. Visualize data

// BAI
var baiScaled = bestSept23.select("bai").unitScale(21.6, 206.7); // 2nd → 98th percentile from your print
var baiVis = {
  bands: ["bai"],
  min: 0,
  max: 1,
...
// NBR
var nbrScaled = bestSept23.select("nbr").unitScale(-0.5, 0.8);
var nbrVis = {
  bands: ["nbr"],
  min: 0,
...
// EVI
var eviScaled = bestSept23.select("evi").unitScale(0, 0.8);
var eviVis = {
  bands: ["evi"],
  min: 0,
  max: 1, // after unitScale
...
// Add to map
Map.addLayer(baiScaled, baiVis, "BAI Sept 2025");
...
Map.addLayer(bestSept23, rgbVis, "Sept 2023 True Color");

// =====================================================================================
// 7. Export bands

// Define export region
var exportRegion = boreal_wildlands.geometry();
...
var rootFolder = "Boreal_Wildlands";
...
Export.table.toDrive({
  collection: boreal_wildlands,
  description: "boreal_wildlands_1km_buffer",
  folder: "Boreal_Wildlands",
  fileNamePrefix: "boreal_wildlands_1km_buffer",
  fileFormat: "SHP",
});
