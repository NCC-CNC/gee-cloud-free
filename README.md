## Description
Google Earth Engine scripts for generating cloud-free Sentinel-2 imagery over an  area of interest and defined date range. Cloudy pixels are removed using the `Cloud Score+` (cs_cdf) band and reflectance bands are scaled to 0–1.
